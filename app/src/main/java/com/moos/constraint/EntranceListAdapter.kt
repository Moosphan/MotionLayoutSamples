...
class EntranceListAdapter(ctx: Context):  androidx.recyclerview.widget.RecyclerView.Adapter<EntranceListAdapter.EntranceViewHolder>(){
    ...
    private val entranceData = arrayListOf(
        Entrance(R.drawable.ic_announcement, "A ball translation", "小球运动"),
        Entrance(R.drawable.ic_pie_chart, "Balls sport", "多球运动"),
        Entrance(R.drawable.ic_presentation, "Motion applies with AppBar", "与AppBarLayout联动"),
        Entrance(R.drawable.ic_savings, "Motion applies with Drawer", "与DrawerLayout联动"),
        Entrance(R.drawable.ic_idea, "Motion applies with ViewPager", "和ViewPager、Lottie联动"),
        Entrance(R.drawable.ic_browser, "Motion with KeyTrigger", "KeyTrigger的使用"),
        Entrance(R.drawable.ic_user, "Multi scenes in User guide page", "多状态实现用户引导页"),
        Entrance(R.drawable.ic_chat, "Motion with KeyCycle", "KeyCycle实现钮扣抖动效果")
    )
